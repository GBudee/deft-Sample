...
namespace Deft {
    public class Sword : EmptyWeapon, IWeapon {

        public Sword(IUnitController unitController, GameManager gameManager, ScenarioLoader scenarioLoader, SelectionManager selectionManager) : base(unitController, gameManager, scenarioLoader, selectionManager) { }
        ...
        protected override List<IUnitController> CheckHit(List<HexEntry> recentPath) {
            ...
            Vector2 targetPos1 = last.BoardPos + HexVectorUtil.RotateClockwise(displacement);
            Vector2 targetPos2 = last.BoardPos + HexVectorUtil.RotateCounterclockwise(displacement);
